...
public class AIAgentStatusProxyState : AIGAgentStateBase
{
    ...
    [Id(4)] public TimeSpan RecoveryDelay { get; set; } = TimeSpan.FromSeconds(60);
    [Id(2)] public long UnavailableCount { get; set; } = 0;
    [Id(3)] public long ExceptionCount { get; set; } = 0;
}