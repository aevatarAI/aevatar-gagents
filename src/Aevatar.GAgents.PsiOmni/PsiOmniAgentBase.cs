    ...
    where TConfiguration : PsiOmniGAgentConfig
{
    ...
    protected async Task<T> TraceEventHandlerAsync<T>(EventBase @event, Func<Task<T>> handler, [CallerMemberName] string handlerName = "")
    {
        if (!_enableEventTracing)
        {
    ...
    protected Task TraceEventHandlerAsync(EventBase @event, Func<Task> handler, [CallerMemberName] string handlerName = "")
    {
    ...
    protected async Task<T> TraceMethodAsync<T>(Func<Task<T>> method, object? parameters = null, [CallerMemberName] string methodName = "")
    {
        if (!_enableEventTracing)
        {
            return await method();
    ...
    protected Task TraceMethodAsync(Func<Task> method, object? parameters = null, [CallerMemberName] string methodName = "")
    {
